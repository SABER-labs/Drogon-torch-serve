...
function(add_sanitizer sanitizer_types)
  ...
  if(UNIX)
    ...
    if(sanitizer_types MATCHES "([Aa]ddress)")
    ...
    if(sanitizer_types MATCHES "([Mm]emory([Ww]ith[Oo]rigins)?)")
    ...
    if(sanitizer_types MATCHES "([Uu]ndefined)")
    ...
    if(sanitizer_types MATCHES "([Tt]hread)")
    ...
    if(sanitizer_types MATCHES "([Ll]eak)")
    ...
    if(sanitizer_types MATCHES "([Cc][Ff][Ii])")
    ...
    message(FATAL_ERROR "sanitizer_types is not supported on this platform.")
  endif()
endfunction()
